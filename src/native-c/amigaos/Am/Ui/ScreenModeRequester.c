...
function_result Am_Ui_ScreenModeRequester__native_init_0(aobject * const this)
{
	...
	aobject * title = __unwrap(this)->object_properties.class_object_properties.properties[0].nullable_value.value.object_value;
	string_holder *title_holder = __unwrap(title)->object_properties.class_object_properties.object_data.value.custom_value;
...
function_result Am_Ui_ScreenModeRequester__native_release_0(aobject * const this)
{
	...
	Am_Ui_ScreenModeRequester_data * data = (Am_Ui_ScreenModeRequester_data *) __unwrap(this)->object_properties.class_object_properties.object_data.value.custom_value;
