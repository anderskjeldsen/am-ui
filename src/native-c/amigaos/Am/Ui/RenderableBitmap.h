#ifndef native_amigaos_aclass_Am_Ui_RenderableBitmap_h
#define native_amigaos_aclass_Am_Ui_RenderableBitmap_h
...
// Native backing data for RenderableBitmap on AmigaOS.
